...
_Tests run on GitHub Actions runners in CI. For local execution, a Docker image is available on Docker Hub._
...
> [!NOTE]
> Reports are generated locally in `./reports/`. </br> Allure reports published to GitHub Pages are generated by CI — not by local Docker runs.
...
> [!NOTE]
> Test data is dynamically generated. </br> Tests are independent and isolated. </br> Simply run each application workflow in GitHub Actions, and open Allure reports once generated by _deploy-allure-reports-to-pages_
